...
.method public applyBatch(Ljava/lang/String;Ljava/util/ArrayList;)[Landroid/content/ContentProviderResult;
    ...
    invoke-static {v7, v6}, Landroid/content/ContentProvider;->access$000(Landroid/content/ContentProvider;Landroid/net/Uri;)V
    ...
    invoke-direct {v4, v5, v7}, Landroid/content/ContentProviderOperation;-><init>(Landroid/content/ContentProviderOperation;Z)V
    ...
    invoke-direct {p0, p1, v6, v7}, Landroid/content/ContentProvider$Transport;->enforceReadPermission(Ljava/lang/String;Landroid/net/Uri;Landroid/os/IBinder;)I
    ...
    invoke-direct {v4, v7, v2}, Landroid/content/OperationApplicationException;-><init>(Ljava/lang/String;I)V
    ...
    invoke-direct {p0, p1, v6, v7}, Landroid/content/ContentProvider$Transport;->enforceWritePermission(Ljava/lang/String;Landroid/net/Uri;Landroid/os/IBinder;)I
    ...
    invoke-static {v3, p1}, Landroid/content/ContentProvider;->access$200(Landroid/content/ContentProvider;Ljava/lang/String;)Ljava/lang/String;
    ...
    invoke-virtual {v5, p2}, Landroid/content/ContentProvider;->applyBatch(Ljava/util/ArrayList;)[Landroid/content/ContentProviderResult;
    ...
    invoke-direct {v6, v7, v8}, Landroid/content/ContentProviderResult;-><init>(Landroid/content/ContentProviderResult;I)V
    ...
    invoke-static {v2, v3}, Landroid/content/ContentProvider;->access$200(Landroid/content/ContentProvider;Ljava/lang/String;)Ljava/lang/String;
    ...
    invoke-static {v4, v3}, Landroid/content/ContentProvider;->access$200(Landroid/content/ContentProvider;Ljava/lang/String;)Ljava/lang/String;
...
.method public bulkInsert(Ljava/lang/String;Landroid/net/Uri;[Landroid/content/ContentValues;)I
    ...
    invoke-static {v0, p2}, Landroid/content/ContentProvider;->access$100(Landroid/content/ContentProvider;Landroid/net/Uri;)Landroid/net/Uri;
...
.method public canonicalize(Ljava/lang/String;Landroid/net/Uri;)Landroid/net/Uri;
    ...
    invoke-static {v3, v1}, Landroid/content/ContentProvider;->access$200(Landroid/content/ContentProvider;Ljava/lang/String;)Ljava/lang/String;
...
.method public delete(Ljava/lang/String;Landroid/net/Uri;Ljava/lang/String;[Ljava/lang/String;)I
    ...
    invoke-static {v2, v8}, Landroid/content/ContentProvider;->access$200(Landroid/content/ContentProvider;Ljava/lang/String;)Ljava/lang/String;
...
.method public getStreamTypes(Landroid/net/Uri;Ljava/lang/String;)[Ljava/lang/String;
    ...
    invoke-static {v0, p1}, Landroid/content/ContentProvider;->access$100(Landroid/content/ContentProvider;Landroid/net/Uri;)Landroid/net/Uri;
...
.method public insert(Ljava/lang/String;Landroid/net/Uri;Landroid/content/ContentValues;)Landroid/net/Uri;
    ...
    invoke-static {v1, p2}, Landroid/content/ContentProvider;->access$100(Landroid/content/ContentProvider;Landroid/net/Uri;)Landroid/net/Uri;
    ...
    :cond_1
    invoke-static {}, Landroid/content/ContentProvider;->access$300()Z
    ...
    invoke-static {v4, v1}, Landroid/content/ContentProvider;->access$200(Landroid/content/ContentProvider;Ljava/lang/String;)Ljava/lang/String;
