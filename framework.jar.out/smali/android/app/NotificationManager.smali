...
.method public notifyAsUser(Ljava/lang/String;ILandroid/app/Notification;Landroid/os/UserHandle;)V
    ...
    invoke-static {v0, p3}, Landroid/app/Notification;->addFieldsFromContext(Landroid/content/Context;Landroid/app/Notification;)V
    ...
    const-string v1, "Notification.sound"
    ...
    invoke-virtual {p3, v0}, Landroid/app/Notification;->reduceImageSizes(Landroid/content/Context;)V
    ...
    .line 402
    .local v10, "isLowRam":Z
    iget-object v0, p0, Landroid/app/NotificationManager;->mContext:Landroid/content/Context;

    invoke-static {p3, v10, v0}, Landroid/app/Notification$Builder;->maybeCloneStrippedForDelivery(Landroid/app/Notification;ZLandroid/content/Context;)Landroid/app/Notification;
...
.method public setOnePlusVibrateInSilentMode(Z)V
    ...
    .local v0, "service":Landroid/app/INotificationManager;
    :try_start_0
    invoke-interface {v0, p1}, Landroid/app/INotificationManager;->setOnePlusVibrateInSilentMode(Z)V
    :try_end_0
    .catch Landroid/os/RemoteException; {:try_start_0 .. :try_end_0} :catch_0
