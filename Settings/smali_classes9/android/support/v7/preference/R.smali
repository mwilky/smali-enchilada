...
.annotation system Ldalvik/annotation/MemberClasses;
    value = {
        Landroid/support/v7/preference/R$xml;,
        Landroid/support/v7/preference/R$transition;,
        Landroid/support/v7/preference/R$styleable;,
        Landroid/support/v7/preference/R$style;,
        Landroid/support/v7/preference/R$string;,
        Landroid/support/v7/preference/R$raw;,
        Landroid/support/v7/preference/R$plurals;,
        Landroid/support/v7/preference/R$mipmap;,
        Landroid/support/v7/preference/R$menu;,
        Landroid/support/v7/preference/R$layout;,
        Landroid/support/v7/preference/R$interpolator;,
        Landroid/support/v7/preference/R$integer;,
        Landroid/support/v7/preference/R$id;,
        Landroid/support/v7/preference/R$fraction;,
        ...
        Landroid/support/v7/preference/R$array;,
        Landroid/support/v7/preference/R$animator;,
