...
.method public onReceive(Landroid/content/Context;Landroid/content/Intent;)V
    ...
    .line 158
    .local v3, "gestureType":I
    const-string v5, "op_fullscreen_gesture_enabled"
    ...
    .line 162
    .local v5, "notchMode":I
    const-string v6, "notch_display"

    invoke-static {v6, v5}, Lcom/oneplus/settings/utils/OPUtils;->sendAppTracker(Ljava/lang/String;I)V
    ...
    iput-object v6, p0, Lcom/oneplus/settings/receiver/SettingsReceiver;->mUm:Landroid/os/UserManager;

    .line 166
    iget-object v6, p0, Lcom/oneplus/settings/receiver/SettingsReceiver;->mUm:Landroid/os/UserManager;
    ...
    invoke-virtual {v6, v7}, Landroid/os/UserManager;->isUserRunning(I)Z
    ...
    const-string v8, "Handle Parallel App Requirement"
    ...
    .line 169
    invoke-static {v6, v8, v4}, Landroid/provider/Settings$System;->getIntForUser(Landroid/content/ContentResolver;Ljava/lang/String;I)I

    move-result v6

    .line 173
    .local v6, "pointerScreenCapture":I
    ...
    .line 173
    invoke-static {v8, v9, v6, v7}, Landroid/provider/Settings$System;->putIntForUser(Landroid/content/ContentResolver;Ljava/lang/String;II)Z
    :try_end_1
    .catch Ljava/lang/Exception; {:try_start_1 .. :try_end_1} :catch_1

    .line 179
    .end local v6    # "pointerScreenCapture":I
    goto :goto_2
    ...
    new-instance v7, Lcom/oneplus/settings/receiver/SettingsReceiver$1;

    invoke-direct {v7, p0, p1}, Lcom/oneplus/settings/receiver/SettingsReceiver$1;-><init>(Lcom/oneplus/settings/receiver/SettingsReceiver;Landroid/content/Context;)V
    ...
    .line 198
    .end local v1    # "isThreeShowEnable":I
    .end local v3    # "gestureType":I
    .end local v5    # "notchMode":I
    :cond_d
