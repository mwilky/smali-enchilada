...
.method public static registerOIMCFunctions(Lcom/oneplus/server/OIMCService;)V
    ...
    const-string v4, "WiFiBackgroudNetLimit"
    ...
    invoke-static {v4}, Lcom/oneplus/util/OemSceneModeUtils;->getInstance(Landroid/content/Context;)Lcom/oneplus/util/OemSceneModeUtils;

    move-result-object v4

    sput-object v4, Lcom/oneplus/server/OIMCUtil;->sOemSceneModeUtils:Lcom/oneplus/util/OemSceneModeUtils;

    sget-object v4, Lcom/oneplus/server/OIMCUtil;->sOemSceneModeUtils:Lcom/oneplus/util/OemSceneModeUtils;

    if-eqz v4, :cond_2

    const-string v4, "NotifyFor3PtyCallsBlocking"

    sget-object v5, Lcom/oneplus/server/OIMCUtil;->sOemSceneModeUtils:Lcom/oneplus/util/OemSceneModeUtils;
    ...
    invoke-static {v4}, Lcom/android/server/OemSceneAutoBrightnessController;->getInstance(Landroid/content/Context;)Lcom/android/server/OemSceneAutoBrightnessController;

    move-result-object v4

    sput-object v4, Lcom/oneplus/server/OIMCUtil;->sOemSceneAutoBrightnessController:Lcom/android/server/OemSceneAutoBrightnessController;
    ...
    const-string v4, "TurnOffAutoBacklight"
    ...
    :cond_3
    sget-boolean v4, Lcom/oneplus/server/OIMCUtil;->HAS_HW_KEYS:Z
    ...
    invoke-static {v4}, Lcom/android/server/OemSceneButtonController;->getInstance(Landroid/content/Context;)Lcom/android/server/OemSceneButtonController;

    move-result-object v4

    sput-object v4, Lcom/oneplus/server/OIMCUtil;->sOemSceneButtonController:Lcom/android/server/OemSceneButtonController;

    sget-object v4, Lcom/oneplus/server/OIMCUtil;->sOemSceneButtonController:Lcom/android/server/OemSceneButtonController;

    if-eqz v4, :cond_4

    const-string v4, "FootKeyBlocking"

    sget-object v5, Lcom/oneplus/server/OIMCUtil;->sOemSceneButtonController:Lcom/android/server/OemSceneButtonController;

    invoke-virtual {v5}, Lcom/android/server/OemSceneButtonController;->getFootButtonLocker()Lcom/android/server/OemSceneButtonController$FootButtonLocker;
    ...
    const-string v4, "VSKeyBlocking"

    sget-object v5, Lcom/oneplus/server/OIMCUtil;->sOemSceneButtonController:Lcom/android/server/OemSceneButtonController;

    invoke-virtual {v5}, Lcom/android/server/OemSceneButtonController;->getVSButtonLocker()Lcom/android/server/OemSceneButtonController$VSButtonLocker;
    ...
    :cond_9
    const-string v4, "AnswerWithoutUI"

    const-string/jumbo v5, "op_oimc_func_answer_without_ui"

    invoke-virtual {p0, v4, v3, v5}, Lcom/oneplus/server/OIMCService;->registerFunction(Ljava/lang/String;ILjava/lang/String;)V

    invoke-virtual {p0}, Lcom/oneplus/server/OIMCService;->getContext()Landroid/content/Context;

    move-result-object v4

    invoke-static {v4}, Lcom/android/server/OemSceneAnswerWithoutUIController;->getInstance(Landroid/content/Context;)Lcom/android/server/OemSceneAnswerWithoutUIController;

    move-result-object v4

    sput-object v4, Lcom/oneplus/server/OIMCUtil;->sOemSceneAnswerWithoutUIController:Lcom/android/server/OemSceneAnswerWithoutUIController;

    sget-object v4, Lcom/oneplus/server/OIMCUtil;->sOemSceneAnswerWithoutUIController:Lcom/android/server/OemSceneAnswerWithoutUIController;

    invoke-virtual {v4}, Lcom/android/server/OemSceneAnswerWithoutUIController;->registerAnswerWithoutUIContentObServer()V

    const-string v4, "FingerprintGestureLimit"

    invoke-virtual {p0}, Lcom/oneplus/server/OIMCService;->getContext()Landroid/content/Context;

    move-result-object v5

    invoke-static {v5}, Lcom/oneplus/server/FingerprintGestureLimit;->getInstance(Landroid/content/Context;)Lcom/oneplus/server/FingerprintGestureLimit;
...
.method public static registerOIMCRulesForBoot(Lcom/oneplus/server/OIMCService;)V
    ...
    sget-object v1, Lcom/oneplus/oimc/OIMCRule;->Rule_VSKeyBlocking:Lcom/oneplus/oimc/OIMCRule;
