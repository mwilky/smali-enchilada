...
.method constructor <init>(Lcom/android/server/am/ActivityManagerService;Lcom/android/server/am/ActivityStackSupervisor;Lcom/android/server/am/ActivityStarter$Factory;)V
    ...
    iput v0, p0, Lcom/android/server/am/ActivityStartController;->deviceWidth:I
...
.method private getSystemConfigurationMetrics(Landroid/content/res/Configuration;)Landroid/graphics/Point;
    .locals 4
...
.method getPreloadLaunchBounds(Lcom/android/server/am/ActivityRecord;Z)Landroid/graphics/Rect;
    .locals 8
    ...
    iget v3, p0, Lcom/android/server/am/ActivityStartController;->deviceWidth:I
    ...
    :goto_0
    iput v6, p0, Lcom/android/server/am/ActivityStartController;->deviceWidth:I

    :cond_2
    iget-object v3, p0, Lcom/android/server/am/ActivityStartController;->mService:Lcom/android/server/am/ActivityManagerService;
    ...
    invoke-direct {p0, v3}, Lcom/android/server/am/ActivityStartController;->getSystemConfigurationMetrics(Landroid/content/res/Configuration;)Landroid/graphics/Point;
    ...
    invoke-virtual {v2, v5}, Landroid/view/DisplayInfo;->getAppMetrics(Landroid/util/DisplayMetrics;)V
    ...
    iget v6, p0, Lcom/android/server/am/ActivityStartController;->deviceWidth:I

    iget v7, p0, Lcom/android/server/am/ActivityStartController;->deviceWidth:I

    add-int/2addr v7, v0

    invoke-direct {v5, v6, v4, v7, v1}, Landroid/graphics/Rect;-><init>(IIII)V
...
.method public isUidInPreloadStack(I)Z
    .locals 9
    ...
    iget-object v2, p0, Lcom/android/server/am/ActivityStartController;->mSupervisor:Lcom/android/server/am/ActivityStackSupervisor;
