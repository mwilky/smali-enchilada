...
.method ensureActivityConfiguration(IZZ)Z
    ...
    invoke-direct {p0, v8, v7}, Lcom/android/server/am/ActivityRecord;->setLastReportedConfiguration(Landroid/content/res/Configuration;Landroid/content/res/Configuration;)V
    ...
    iget-object v10, p0, Lcom/android/server/am/ActivityRecord;->mLastReportedConfiguration:Landroid/util/MergedConfiguration;
    ...
    :cond_29
    sget-boolean v8, Lcom/android/server/am/ActivityManagerDebugConfig;->DEBUG_STATES:Z
...
.method public onWindowsVisible()V
    ...
    invoke-virtual {v4, v1}, Lcom/android/server/am/TaskRecord;->setLoadFinished(Z)V
    ...
    iput-boolean v2, v1, Lcom/android/server/am/ActivityManagerService;->mActivityBusy:Z
...
.method setRequestedOrientation(I)V
    ...
    invoke-virtual {v3}, Lcom/android/server/am/TaskRecord;->getOverrideConfiguration()Landroid/content/res/Configuration;
    ...
    invoke-virtual {v5}, Lcom/android/server/am/ActivityManagerService;->getActivityStartController()Lcom/android/server/am/ActivityStartController;

    move-result-object v5

    invoke-virtual {v5, p0, v4}, Lcom/android/server/am/ActivityStartController;->getPreloadLaunchBounds(Lcom/android/server/am/ActivityRecord;Z)Landroid/graphics/Rect;

    move-result-object v5

    iget-object v6, p0, Lcom/android/server/am/ActivityRecord;->task:Lcom/android/server/am/TaskRecord;

    invoke-virtual {v6, v5}, Lcom/android/server/am/TaskRecord;->updateOverrideConfiguration(Landroid/graphics/Rect;)Z
    ...
    invoke-virtual {v6, v2, v1}, Lcom/android/server/wm/TaskWindowContainerController;->resize(ZZ)V

    iget-object v1, p0, Lcom/android/server/am/ActivityRecord;->mWindowContainerController:Lcom/android/server/wm/AppWindowContainerController;

    invoke-virtual {v1, p1}, Lcom/android/server/wm/AppWindowContainerController;->setOrientationOnly(I)V
    ...
    invoke-virtual {v3, v0}, Lcom/android/server/am/ActivityStackSupervisor;->getDisplayOverrideConfiguration(I)Landroid/content/res/Configuration;
    ...
    invoke-virtual {p0, v5}, Lcom/android/server/am/ActivityRecord;->mayFreezeScreenLocked(Lcom/android/server/am/ProcessRecord;)Z

    move-result v5

    invoke-virtual {v4, p1, v0, v3, v5}, Lcom/android/server/wm/AppWindowContainerController;->setOrientation(IILandroid/content/res/Configuration;Z)Landroid/content/res/Configuration;
    ...
    invoke-virtual {v2, v4, p0, v1, v0}, Lcom/android/server/am/ActivityManagerService;->updateDisplayOverrideConfigurationLocked(Landroid/content/res/Configuration;Lcom/android/server/am/ActivityRecord;ZI)Z
    ...
    invoke-virtual {v1, v2, p1}, Lcom/android/server/am/TaskChangeNotificationController;->notifyActivityRequestedOrientationChanged(II)V
...
.method showStartingWindow(Lcom/android/server/am/ActivityRecord;ZZZ)V
    ...
    invoke-virtual {v2}, Lcom/android/server/am/TaskRecord;->isPreloadTask()Z
