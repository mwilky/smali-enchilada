.class Lcom/android/server/policy/OemPhoneWindowManager$KillApp;
...
.method constructor <init>(Lcom/android/server/policy/OemPhoneWindowManager;)V
    ...
    iput-object p1, p0, Lcom/android/server/policy/OemPhoneWindowManager$KillApp;->this$0:Lcom/android/server/policy/OemPhoneWindowManager;
...
.method private getApplicationNameFromPageName(Ljava/lang/String;)Ljava/lang/String;
    ...
    iget-object v4, p0, Lcom/android/server/policy/OemPhoneWindowManager$KillApp;->this$0:Lcom/android/server/policy/OemPhoneWindowManager;
...
.method public run()V
    ...
    iget-object v10, p0, Lcom/android/server/policy/OemPhoneWindowManager$KillApp;->this$0:Lcom/android/server/policy/OemPhoneWindowManager;

    iget-object v7, v10, Lcom/android/server/policy/OemPhoneWindowManager;->mContext:Landroid/content/Context;
    ...
    invoke-direct {p0, v5}, Lcom/android/server/policy/OemPhoneWindowManager$KillApp;->isWhitelisted(Ljava/lang/String;)Z

    move-result v6

    if-nez v6, :cond_1

    invoke-direct {p0, v5}, Lcom/android/server/policy/OemPhoneWindowManager$KillApp;->isHomeApplication(Ljava/lang/String;)Z
    ...
    invoke-interface {v11, v6}, Landroid/app/IActivityManager;->removeTask(I)Z
    ...
    :goto_0
    invoke-direct {p0, v5}, Lcom/android/server/policy/OemPhoneWindowManager$KillApp;->getApplicationNameFromPageName(Ljava/lang/String;)Ljava/lang/String;
