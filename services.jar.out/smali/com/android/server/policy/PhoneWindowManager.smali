...
.field private static final MSG_TOGGLE_TORCH:I = 0x1f
...
.method private interceptPowerKeyDown(Landroid/view/KeyEvent;Z)V
    ...
    iput v9, p0, Lcom/android/server/policy/PhoneWindowManager;->mResolvedLongPressOnPowerBehavior:I
...
.method public interceptKeyBeforeDispatching(Lcom/android/server/policy/WindowManagerPolicy$WindowState;Landroid/view/KeyEvent;I)J
    ...
    iget-wide v14, v1, Lcom/android/server/policy/PhoneWindowManager;->mDoubleClickVolumeKeyReleaseTime:J

    sub-long/2addr v12, v14

    sget-wide v14, Lcom/android/server/policy/PhoneWindowManager;->DOUBLE_CLICK_VOLUME_DEBOUNCE_DELAY_MILLIS:J
    ...
    iget-wide v14, v1, Lcom/android/server/policy/PhoneWindowManager;->mScreenshotChordVolumeUpKeyTime:J
    ...
    invoke-virtual {v0, v12}, Lcom/android/internal/accessibility/AccessibilityShortcutController;->isAccessibilityShortcutAvailable(Z)Z
    ...
    iget-boolean v13, v1, Lcom/android/server/policy/PhoneWindowManager;->mA11yShortcutChordVolumeUpKeyTriggered:Z
    ...
    iget-boolean v12, v1, Lcom/android/server/policy/PhoneWindowManager;->mEnableShiftMenuBugReports:Z
    ...
    :try_start_0
    invoke-interface {v12}, Lcom/android/internal/statusbar/IStatusBarService;->expandNotificationsPanel()V
    :try_end_0
    .catch Landroid/os/RemoteException; {:try_start_0 .. :try_end_0} :catch_0
    ...
    iget-boolean v12, v1, Lcom/android/server/policy/PhoneWindowManager;->mPendingCapsLockToggle:Z

    if-nez v12, :cond_3b

    iget v12, v1, Lcom/android/server/policy/PhoneWindowManager;->mMetaState:I

    iput v12, v1, Lcom/android/server/policy/PhoneWindowManager;->mInitialMetaState:I
    ...
    invoke-virtual {v1, v9, v0}, Lcom/android/server/policy/PhoneWindowManager;->startActivityAsUser(Landroid/content/Intent;Landroid/os/UserHandle;)V
...
.method public skipWake()Z
    ...
    .line 655
    invoke-virtual {p0}, Lcom/android/server/policy/OemPhoneWindowManager;->isScreenOn()Z

    move-result v0

    if-eqz v0, :cond_f

    invoke-virtual {p0}, Lcom/android/server/policy/OemPhoneWindowManager;->isDozeMode()Z
