...
.annotation system Ldalvik/annotation/MemberClasses;
    value = {
        Lcom/android/server/LocationManagerService$PendingRequest;,
...
.method public constructor <init>(Landroid/content/Context;)V
    ...
    iput-object v0, p0, Lcom/android/server/LocationManagerService;->mPendingRequests:Ljava/util/ArrayList;
...
.method public delPendingRequest(Ljava/lang/String;I)V
    .locals 7

    iget-object v0, p0, Lcom/android/server/LocationManagerService;->mPendingRequests:Ljava/util/ArrayList;

    monitor-enter v0

    :try_start_0
    iget-object v1, p0, Lcom/android/server/LocationManagerService;->mPendingRequests:Ljava/util/ArrayList;
    ...
    iget-object v3, p0, Lcom/android/server/LocationManagerService;->mPendingRequests:Ljava/util/ArrayList;

    invoke-virtual {v3, v2}, Ljava/util/ArrayList;->get(I)Ljava/lang/Object;

    move-result-object v3

    check-cast v3, Lcom/android/server/LocationManagerService$PendingRequest;

    iget-object v4, v3, Lcom/android/server/LocationManagerService$PendingRequest;->mPackageNamae:Ljava/lang/String;
    ...
    iget v4, v3, Lcom/android/server/LocationManagerService$PendingRequest;->mUid:I
    ...
    const-string v6, "delete PendingResuest : "
    ...
    iget-object v4, p0, Lcom/android/server/LocationManagerService;->mPendingRequests:Ljava/util/ArrayList;
...
.method public requestLocationUpdates(Landroid/location/LocationRequest;Landroid/location/ILocationListener;Landroid/app/PendingIntent;Ljava/lang/String;)V
    ...
    invoke-virtual {v1, v10}, Lcom/android/server/preload/PreloadUtils;->isPreload(Ljava/lang/String;)Z

    move-result v1

    if-eqz v1, :cond_0

    new-instance v12, Lcom/android/server/LocationManagerService$PendingRequest;
    ...
    invoke-direct/range {v1 .. v7}, Lcom/android/server/LocationManagerService$PendingRequest;-><init>(Landroid/location/LocationRequest;Landroid/location/ILocationListener;Landroid/app/PendingIntent;Ljava/lang/String;II)V
    ...
    const-string v4, "add PendingRequest for : "
    ...
    iget-object v2, v9, Lcom/android/server/LocationManagerService;->mPendingRequests:Ljava/util/ArrayList;
    ...
    :cond_0
    iget-object v1, v9, Lcom/android/server/LocationManagerService;->mPendingRequests:Ljava/util/ArrayList;
    ...
    check-cast v2, Lcom/android/server/LocationManagerService$PendingRequest;

    iget-object v3, v2, Lcom/android/server/LocationManagerService$PendingRequest;->mPackageNamae:Ljava/lang/String;
    ...
    invoke-direct {v9, v14, v0}, Lcom/android/server/LocationManagerService;->checkResolutionLevelIsSufficientForProviderUse(ILjava/lang/String;)V
    ...
    invoke-direct {v9, v13, v14, v7}, Lcom/android/server/LocationManagerService;->createSanitizedRequest(Landroid/location/LocationRequest;IZ)Landroid/location/LocationRequest;

    move-result-object v17

    if-eqz v12, :cond_7

    iget v0, v12, Lcom/android/server/LocationManagerService$PendingRequest;->mPid:I

    iget v1, v12, Lcom/android/server/LocationManagerService$PendingRequest;->mUid:I
    ...
    :try_start_0
    invoke-virtual {v9, v8, v11, v10, v14}, Lcom/android/server/LocationManagerService;->checkLocationAccess(IILjava/lang/String;I)Z
...
.method public restartPendingResuest(Ljava/lang/String;I)V
    .locals 8
    ...
    const-string/jumbo v6, "restartPendingResuest : "
    ...
    iget-object v4, v3, Lcom/android/server/LocationManagerService$PendingRequest;->mRequest:Landroid/location/LocationRequest;

    iget-object v5, v3, Lcom/android/server/LocationManagerService$PendingRequest;->mlistener:Landroid/location/ILocationListener;

    iget-object v6, v3, Lcom/android/server/LocationManagerService$PendingRequest;->mPendingIntent:Landroid/app/PendingIntent;

    iget-object v7, v3, Lcom/android/server/LocationManagerService$PendingRequest;->mPackageNamae:Ljava/lang/String;

    invoke-virtual {p0, v4, v5, v6, v7}, Lcom/android/server/LocationManagerService;->requestLocationUpdates(Landroid/location/LocationRequest;Landroid/location/ILocationListener;Landroid/app/PendingIntent;Ljava/lang/String;)V
