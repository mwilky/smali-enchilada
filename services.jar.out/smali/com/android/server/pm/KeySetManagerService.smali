...
.method private addKeySetLPw(Landroid/util/ArraySet;)Lcom/android/server/pm/KeySetHandle;
    ...
    .line 463
    .restart local v2    # "ks":Lcom/android/server/pm/KeySetHandle;
    ...
    .end local v2    # "ks":Lcom/android/server/pm/KeySetHandle;
    .end local v3    # "existingKeySetId":J
    .end local v5    # "id":J
    :cond_3
...
.method private addRefCountsFromSavedPackagesLPw(Landroid/util/ArrayMap;)V
    ...
    .line 838
    .local v2, "orphanedKeySets":Landroid/util/ArraySet;, "Landroid/util/ArraySet<Ljava/lang/Long;>;"
    iget-object v3, p0, Lcom/android/server/pm/KeySetManagerService;->mKeySets:Landroid/util/LongSparseArray;
...
.method addDefinedKeySetsToPackageLPw(Lcom/android/server/pm/PackageSetting;Landroid/util/ArrayMap;)V
    ...
    .line 292
    .local v6, "pubKeys":Landroid/util/ArraySet;, "Landroid/util/ArraySet<Ljava/security/PublicKey;>;"
    if-eqz v5, :cond_0
    ...
    .end local v6    # "pubKeys":Landroid/util/ArraySet;, "Landroid/util/ArraySet<Ljava/security/PublicKey;>;"
...
.method public checkUpgradeKeySetLocked(Lcom/android/server/pm/PackageSettingBase;Landroid/content/pm/PackageParser$Package;)Z
    ...
    .line 374
    .local v3, "upgradeSet":Ljava/util/Set;, "Ljava/util/Set<Ljava/security/PublicKey;>;"
    if-eqz v3, :cond_0
    ...
    .line 372
    .end local v3    # "upgradeSet":Ljava/util/Set;, "Ljava/util/Set<Ljava/security/PublicKey;>;"
    :cond_0
    add-int/lit8 v2, v2, 0x1
...
.method public dumpLPr(Ljava/io/PrintWriter;Ljava/lang/String;Lcom/android/server/pm/DumpState;)V
    ...
    .line 639
    .local v9, "definedKeySets":Landroid/util/ArrayMap;, "Landroid/util/ArrayMap<Ljava/lang/String;Ljava/lang/Long;>;"
    ...
    .line 650
    .end local v9    # "definedKeySets":Landroid/util/ArrayMap;, "Landroid/util/ArrayMap<Ljava/lang/String;Ljava/lang/Long;>;"
    .end local v11    # "dksSize":I
...
.method readKeySetsLPw(Lorg/xmlpull/v1/XmlPullParser;Landroid/util/ArrayMap;)V
    ...
    .line 727
    .local v3, "recordedVersionStr":Ljava/lang/String;
    const/4 v5, 0x1
...
.method writeKeySetsLPr(Lorg/xmlpull/v1/XmlSerializer;)V
    ...
    .line 706
    .end local v2    # "id":J
    .end local v4    # "keys":Landroid/util/ArraySet;, "Landroid/util/ArraySet<Ljava/lang/Long;>;"
    add-int/lit8 v0, v0, 0x1
